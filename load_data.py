...
def filtering_data_scraper_old(transform_f, s_folder_path, s_data_file_name, s_width_height,
        ...
        with (torch.no_grad()):
            ...
            # for i in range(16):
                ...
                for input_idx_upper_left_h_w in input_indecies_upper_left_h_w:
                    ...
                    # Filter data
                    if filter_old(input_sequence, target, s_min_rain_ratio_target):
                    # if True:
...
def filter_old(input_sequence: torch.Tensor, target: torch.Tensor, s_min_rain_ratio_target, percentage=0.5, min_amount_rain=0.2):
