...
def train(model, start_date_time: datetime.datetime, device, folder_path: str, num_training_samples: int,
    ...
    data_set = PrecipitationDataset(data_sequence, num_pictures_loaded, num_channels_one_hot_output)
...
if __name__ == '__main__':
    ...
    num_training_samples = 10 # Number of loaded pictures (first pics not used for training but only input)
