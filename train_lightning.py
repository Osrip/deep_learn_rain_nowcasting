    ...
    settings = \
        {
            ...
            's_num_gpus': 4,
            's_batch_size': 45, # 1080--> 18 läuft 2080-->14 --> 7GB /10GB; v100 --> 45  55, downgraded to 45 after memory issue on v100 with smoothing stuff
